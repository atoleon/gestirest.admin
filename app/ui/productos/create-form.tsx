...
import { crearProducto, State } from '@/app/lib/productos/actions';
import { useActionState } from 'react';

export default function CrearProductoForm({ proveedores }: { proveedores: ProveedorField[] }) {
  const initialState: State = { message: null, errors: {} };
  const [state, formAction] = useActionState(crearProducto, initialState);
